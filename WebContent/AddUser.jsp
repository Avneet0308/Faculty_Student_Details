...
%>
	<div class="logodiv"><a href="http://www.psit.ac.in/index.php" style="text-decoration: none;color: white;"><img class="logoimg" src="logo-with-name1.png" height="62" width="78">&nbsp&nbsp&nbsp&nbsp<p class="logotxt">Pranveer Singh Institute of Technology</p></a></div>
    <nav class="topbar">
...
<div id="mySidenav" class="sidenav">
  ...
  <div class="dmain">
  <form onsubmit="return check(event)" action="AddUser" method="post">
 <table>
<tr><p>Name : <input id="Name" type="text" name="name"></p></tr>
<tr><p>Department : <input id="Dept" type="text" name="dept"></p></tr>
<tr><p>Area of expertise : <input id="AOE" type="text" name="aoe"></p></tr>
<tr><p>Personal interest : <input id="PI" type="text" name="pi"></p></tr>
